...
> **阅读定位**：这是增长方法论体系里关于“搜索获客”的一篇。建议先读 [产品增长通用框架](../growth-dimension-framework/) 理解增长杠杆，再读 [业务拆解方法论](../business-teardown-methodology/) 判断一个业务适不适合做搜索获客。本文不想写成 SEO 百科，而是回答一个更具体的问题：**早期产品在不同阶段，到底应该怎么做 SEO？**
